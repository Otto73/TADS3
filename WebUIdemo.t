 ...
 */
versionInfo: GameID
    IFID = '39caeca0-4077-442c-81f2-f3c02dcb805c'
    name = 'WebUIdemo'
    byline = 'by Otto73'
    htmlByline = 'by <a href="mailto:ottocondliffe@gmail.com">
                  Otto73</a>'
    version = '1'
    authorEmail = 'Otto73 <ottocondliffe@gmail.com>'
    desc = 'Demo for some advanced features of the web UI'
    htmlDesc = 'Demo for some advanced features of the web UI'
...
gameMain: GameMainDef
    ...
    showIntro()
    {
        ...
        "<.inputline>";
        "<FONT COLOR=#6af268>Press ENTER or <<aHref('', 'CLICK HERE ')>>to continue.</FONT>";
        "<./inputline>";
        do 
        {
